...
int main() {
  ...
  for (a=0; a<MAX; a++) {
    for (b=0; b<MAX; b++) {
      coord_s = malloc(2*sizeof(int));
      coord_s[0] = a;
      coord_s[1] = b;
      pthread_create(&threads_s[idx++], NULL, computeSum, (void *)coord_s);
    }
  }
  ...
  for (a=0; a<MAX; a++) {
    for (b=0; b<MAX; b++) {
      coord_d = malloc(2*sizeof(int));
      coord_d[0] = a;
      coord_d[1] = b;
      pthread_create(&threads_d[idx++], NULL, computeDiff, (void *)coord_d);
    }
  }
